...
export function WorkerMyRecordsPage() {
  return (
    <section className="space-y-6">
      <header>
        <h2 className="text-2xl font-bold text-[var(--color-foreground)]">Mis registros</h2>
        <p className="mt-1 text-sm text-[var(--color-muted-foreground)]">
          Elija el tipo de registro que desea revisar o completar.
        </p>
      </header>
